...
namespace HC.Core.Time
{
    ...
    {
        public static string[][] TimeZones { get; private set; }
        public static Dictionary<string, string> ZoneLookup { get; private set; }
        ...
        static TimeZoneHelper()
        {
            ...
            ZoneLookup = new Dictionary<string, string>();
            foreach (string[] tokens in TimeZones)
            {
                ZoneLookup[tokens[0]] = tokens[1];
            }
        }
    }
}
